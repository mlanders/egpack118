...
const ICAL_URL = 'https://calendar.google.com/calendar/ical/ld2c70e20kot5palni2skd61bjlr71s6%40import.calendar.google.com/public/basic.ics';
const OUTPUT_PATH = join(__dirname, '../src/content/calendar.md');
...
function generateMarkdown(events) {
  ...
  filteredEvents.forEach(event => {
    const monthKey = event.startDate.toLocaleDateString('en-US', { year: 'numeric', month: 'long' });
