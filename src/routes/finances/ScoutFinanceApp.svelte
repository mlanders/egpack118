    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        {#if activeTab === "reconciliation"}
            <div class="p-4 space-y-4">
                ...
                >
                    Verify that pack cash on hand equals scout earmarked
                    balances plus unallocated funds.
                </div>
                ...
                >
                    ...
                    {#if packFinances().unallocatedFunds < 0}
                        <div
                            class="bg-yellow-50 border border-yellow-200 rounded-md p-3 text-sm text-yellow-800"
                        >
                            <strong>Warning:</strong> Negative unallocated funds means
                            the pack has earmarked more than available.
                        </div>
                    {/if}
                </div>

                <h3 class="text-base font-semibold text-gray-900">
                    Scout Balance Details
                </h3>
                <div
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                {:else}
                                    ...
                                    <tr class="bg-gray-50 font-semibold">
                                        ...
                                        >
                                        <td
                                            class="px-4 py-3 text-sm text-right text-gray-900"
                                        >
                                            ${packFinances().totalEarmarked.toFixed(
                                                2,
                                            )}
                                        </td>
                                    </tr>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                {#each getAvailableFiscalYears() as year}
                                    ...
                                    {@const yearPackTransactions =
                                        packTransactions.filter(
                                            (t) => t.fiscalYear === year,
                                        )}
                                    {@const activeScoutCount =
                                        yearScouts.filter(
                                            (s) => s.active,
                                        ).length}
                                    ...
                                    {@const yearUnallocated =
                                        yearPackCash - yearEarmarked}
                                ...
                                {#if getAvailableFiscalYears().length === 0}
                                    <tr>
                                        ...
                                        >
                                            No fiscal year data yet. Add scouts
                                            and transactions to see summaries.
                                        </td>
                                    </tr>
                                {/if}
                            </tbody>
