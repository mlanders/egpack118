                        ...
                        {:else}
                            {#each users as user}
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3">
                                        <span
                                            class="px-2 py-1 text-xs font-medium rounded-full {getRoleBadgeClass(
                                                user.role,
                                            )}"
                                        >
                                            {user.role}
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        <button
                                            onclick={() =>
                                                copyToClipboard(
                                                    `${window.location.origin}/finances/accept-invite?token=${invitation.token}`,
                                                )}
                ...
                <div class="mb-4">
                    ...
                    >
                        ...
                        <option value="TREASURER"
                            >Treasurer (Full Access)</option
                        >
                        {#if isAdmin}
                            <option value="ADMIN"
                                >Admin (Full Access + User Management)</option
                            >
                        {/if}
                    </select>
                </div>
    ...
    >
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
            ...
            <p class="text-sm text-gray-600 mb-4">
                Resetting password for: <strong>{resetUserEmail}</strong>
            </p>
            ...
            >
                ...
                {#if successMessage}
                    <div
                        class="mb-4 p-2.5 bg-green-50 border border-green-200 text-green-700 rounded-md text-sm"
                    >
                        {successMessage}
                    </div>
                {/if}
